...
public class ListaCircular<Dado> where Dado : IComparable<Dado>
{
    ...
    private void RemoverNo(NoLista<Dado> anterior, NoLista<Dado> atual)
    {
                               ...
                               ref NoLista<Dado> atuM)
    {
        antM = anterior = null;
        atuM = atual = primeiro;
        while (atual != ultimo)// mudei de null para ultimo
        {
    ...
    public void Ordenar()
    {
        ...
        var listaOrdenada = new ListaCircular<Dado>();
